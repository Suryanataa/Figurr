...
(function () {
	...
	tabs.each(function () {
		var thisTabs = $(this),
			nav = thisTabs.find(".js-tabs-linkk"),
			item = thisTabs.find(".js-tabs-itemm");
		nav.on("click", function () {
			var thisNav = $(this),
				indexNav = thisNav.index();
			nav.removeClass("active");
...
(function () {
	var tabs = $(".js-nav-edit");
	tabs.each(function () {
		var thisTabs = $(this),
			nav = thisTabs.find(".js-edit-link"),
			item = thisTabs.find(".js-edit-item");
		nav.on("click", function () {
			var thisNav = $(this),
				indexNav = thisNav.index();
			nav.removeClass("active");
	...
	$(document).ready(function () {
		...
		option.on("click", function () {
			var thisOption = $(this),
				indexOption = thisOption.index();
			$(".js-edit-item").hide();
			$(".js-edit-item").eq(indexOption).fadeIn();
		});
	});
})(); // faq
(function () {
